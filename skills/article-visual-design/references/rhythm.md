...
模板位于 `claudecode/templates/article/`：
...
- 模板路径: claudecode/templates/article/{template}.yaml
- 选择理由: {1 句话说明为什么选这个模板}
- 章节数: {N}
...
- 模板路径: claudecode/templates/article/long-form-essay.yaml
...
- 所选模板: listicle
- 模板路径: claudecode/templates/article/listicle.yaml
...
- 文章标题: 手冲咖啡的 4 个关键步骤
- 所选模板: tutorial
- 模板路径: claudecode/templates/article/tutorial.yaml
