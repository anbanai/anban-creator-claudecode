...
| `seedance-20`、`seedance-20/skills/*` | 内置/改编自 [Emily2040/seedance-2.0](https://github.com/Emily2040/seedance-2.0)（MIT Skill OS） | 加入 Anban MCP 边界、`video` agent 统一流程、商业 playbook、交付 QC、任务文件契约 | 更新根 skill、嵌套 `skills/*`、`references/` 与迁移材料；重新校验平台/API/价格类信息，不要绕过 Anban MCP |
